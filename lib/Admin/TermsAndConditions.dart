...
class _TermsandconditionsState extends State<Termsandconditions> {
  ...
  Future<void> getonetheload() async {
    ...
    setState(() {
      termsStream = termsStream;
    });
    }
    catch(e){
      print('Error fetching terms and conditions');
    }
  }
  @override
  void initState() {
  ...
  Widget termsAndConditions() => Text(termsStream.join('\n\n'),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: 300,
                      height: 700,
                      child: Expanded(child: termsAndConditions(),
                      )),
                  ),
                ],
              ),
